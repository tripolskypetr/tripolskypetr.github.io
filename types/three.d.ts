...
declare namespace THREE {
    interface SpriteCanvasMaterialParameters extends MaterialParameters {
        color?: number;
...
declare namespace THREE {
    ...
    const CubeUVReflectionMapping: Mapping;
    const CubeUVRefractionMapping: Mapping;
    enum Wrapping {
    }
    ...
    const UnsignedInt248Type: PixelType;
    enum PixelFormat {
    }
    ...
    const DepthFormat: PixelFormat;
    const DepthStencilFormat: PixelFormat;
    ...
    const RGB_ETC1_Format: CompressedPixelFormat;
    enum AnimationActionLoopStyles {
    }
    const LoopOnce: AnimationActionLoopStyles;
    const LoopRepeat: AnimationActionLoopStyles;
    const LoopPingPong: AnimationActionLoopStyles;
    ...
    const TrianglesDrawMode: TrianglesDrawModes;
    ...
    const BasicDepthPacking: DepthPackingStrategies;
    const RGBADepthPacking: DepthPackingStrategies;
    ...
    namespace UniformsUtils {
        ...
        function clone(uniforms_src: any): any;
    }
    class Uniform {
    ...
    class DepthTexture extends Texture {
        constructor(width: number, heighht: number, type?: TextureDataType, mapping?: Mapping, wrapS?: Wrapping, wrapT?: Wrapping, magFilter?: TextureFilter, minFilter?: TextureFilter, anisotropy?: number);
        image: {
            width: number;
            height: number;
        };
    ...
    class CanvasTexture extends Texture {
        constructor(canvas: HTMLImageElement | HTMLCanvasElement | HTMLVideoElement, mapping?: Mapping, wrapS?: Wrapping, wrapT?: Wrapping, magFilter?: TextureFilter, minFilter?: TextureFilter, format?: PixelFormat, type?: TextureDataType, anisotropy?: number);
    }
    class CubeTexture extends Texture {
        constructor(images?: any[], // HTMLImageElement or HTMLCanvasElement
        mapping?: Mapping, wrapS?: Wrapping, wrapT?: Wrapping, magFilter?: TextureFilter, minFilter?: TextureFilter, format?: PixelFormat, type?: TextureDataType, anisotropy?: number, encoding?: TextureEncoding);
        images: any;
    }
    class CompressedTexture extends Texture {
        constructor(mipmaps: ImageData[], width: number, height: number, format?: PixelFormat, type?: TextureDataType, mapping?: Mapping, wrapS?: Wrapping, wrapT?: Wrapping, magFilter?: TextureFilter, minFilter?: TextureFilter, anisotropy?: number, encoding?: TextureEncoding);
        image: {
            width: number;
            height: number;
        };
    ...
    class DataTexture extends Texture {
        constructor(data: ArrayBuffer | Int8Array | Uint8Array | Uint8ClampedArray | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array | Float64Array, width: number, height: number, format: PixelFormat, type: TextureDataType, mapping: Mapping, wrapS: Wrapping, wrapT: Wrapping, magFilter: TextureFilter, minFilter: TextureFilter, anisotropy?: number, encoding?: TextureEncoding);
        image: ImageData;
    }
    ...
    namespace SceneUtils {
        function createMultiMaterialObject(geometry: Geometry, materials: Material[]): Object3D;
    ...
    namespace ShapeUtils {
        function area(contour: number[]): number;
        function triangulate(contour: number[], indices: boolean): number[];
        function triangulateShape(contour: number[], holes: any[]): number[];
        function isClockWise(pts: number[]): boolean;
        function b2(t: number, p0: number, p1: number, p2: number): number;
